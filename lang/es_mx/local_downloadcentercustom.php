...
$string['download_mode_title'] = 'MODO DE DESCARGA';
$string['mode_normal'] = 'Descarga normal';
$string['mode_portfolio'] = 'Portafolio de evidencias';
$string['all_students_header'] = 'TODOS LOS ESTUDIANTES';
$string['all_students'] = 'Todos los estudiantes';
$string['select_students'] = 'SELECCIONAR ESTUDIANTES';
$string['select_students_one_by_one'] = 'Seleccionar alumnos uno por uno';
