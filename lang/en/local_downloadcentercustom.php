...
$string['download_mode_title'] = 'DOWNLOAD MODE';
$string['mode_normal'] = 'Normal download';
$string['mode_portfolio'] = 'Evidence portfolio';
$string['all_students_header'] = 'ALL STUDENTS';
$string['all_students'] = 'All students';
$string['select_students'] = 'SELECT STUDENTS';
$string['select_students_one_by_one'] = 'Select students one by one';
...
$string['string_grade_report'] = 'Grade report';
$string['string_grade_report_item'] = 'Grade item';
$string['string_grade_report_grade'] = 'Grade';
$string['string_grade_report_max'] = 'Maximum grade';
$string['string_grade_report_feedback'] = 'Feedback';
...
$string['string_no_grade'] = 'No grade';
$string['string_not_done'] = 'Not done';
